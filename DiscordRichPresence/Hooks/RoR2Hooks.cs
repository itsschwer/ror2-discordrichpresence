...
namespace DiscordRichPresence.Hooks
{
    public static class RoR2Hooks
    {
        ...
        private static void Stage_onStageStartGlobal(Stage obj)
        {
            ...
            var richPresence = RichPresence;
            richPresence.Assets.SmallImage = "https://raw.githubusercontent.com/gamrtiem/RoR2-Discord-RP/refs/heads/master/Assets/Characters/" + InfoTextUtils.GetCharacterInternalName(localBody.GetDisplayName()) + ".png";
